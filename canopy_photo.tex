...
\newcommand\menu[1]{\texttt{\color{blue}#1}  % define in-line code formatting
\newcommand\file[1]{\texttt{\underline{#1}}}  % define in-line code formatting
...
\begin{figure}[H]
\centering
	\includegraphics[width=\textwidth]{hemi_layout}
...
% Update hemispherical photography manual - the benefit of using hemispherical photos is bein able to calculate LAI, and also in understanding PAR at ground level at a single point. If you're just interested in canopy cover, then use a periscope densitometer or a flat square lens, like on a mobile phone
